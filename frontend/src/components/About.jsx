  ...
  return (
    <div className="min-h-screen bg-background dark:bg-background">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none dark:prose-invert">
              ...
              <Card className="mb-8 border-l-4 border-l-blue-600 bg-card border-border">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold mb-2 text-foreground">Guided by Excellence</h3>
      ...
      <div className="py-20 bg-background dark:bg-background">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12 text-foreground">Why did we build this?</h2>
      ...
      <div className="py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-foreground">Built with Modern Technology</h2>
            <p className="text-xl text-muted-foreground">
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col items-center p-4 bg-muted/50 rounded-lg">
                    <div className="text-2xl mb-2">🎯</div>
                    <span className="font-medium text-foreground">Modern UI</span>
                  </div>
                </div>
              </CardContent>
            </Card>
